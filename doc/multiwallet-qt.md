...
In order to support loading of multiple wallets in strayacash-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is strayacash.cpp.
...
Changes to strayacash.cpp
----------------------
strayacash.cpp is the entry point into strayacash-qt, and as such, will require some minor modifications to provide hooks for
