...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("strayacash strayacash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  strayacash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded strayacash transaction") + "\n" +
                               "  strayacash-tx [options] -create [commands]   " + _("Create hex-encoded strayacash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded strayacash transaction
