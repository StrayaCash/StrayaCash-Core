...
Value stop(const Array& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop strayacash server.");
    // Shutdown will take long enough that the response should get back
    StartShutdown();
    return "strayacash server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* strayacash features */
        {"strayacash", "masternode", &masternode, true, true, false},
        {"strayacash", "listmasternodes", &listmasternodes, true, true, false},
        {"strayacash", "getmasternodecount", &getmasternodecount, true, true, false},
        {"strayacash", "masternodeconnect", &masternodeconnect, true, true, false},
        {"strayacash", "masternodecurrent", &masternodecurrent, true, true, false},
        {"strayacash", "masternodedebug", &masternodedebug, true, true, false},
        {"strayacash", "startmasternode", &startmasternode, true, true, false},
        {"strayacash", "createmasternodekey", &createmasternodekey, true, true, false},
        {"strayacash", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"strayacash", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"strayacash", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"strayacash", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"strayacash", "getmasternodescores", &getmasternodescores, true, true, false},
        {"strayacash", "mnbudget", &mnbudget, true, true, false},
        {"strayacash", "preparebudget", &preparebudget, true, true, false},
        {"strayacash", "submitbudget", &submitbudget, true, true, false},
        {"strayacash", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"strayacash", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"strayacash", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"strayacash", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"strayacash", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"strayacash", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"strayacash", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"strayacash", "checkbudgets", &checkbudgets, true, true, false},
        {"strayacash", "mnsync", &mnsync, true, true, false},
        {"strayacash", "spork", &spork, true, true, false},
        {"strayacash", "getpoolinfo", &getpoolinfo, true, true, false},
#ifdef ENABLE_WALLET
        {"strayacash", "obfuscation", &obfuscation, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use strayacashd, or the -server option to strayacash-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> strayacash-cli " + methodname + " " + args + "\n";
}
