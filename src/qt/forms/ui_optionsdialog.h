...
public:
    ...
    void setupUi(QDialog *OptionsDialog)
    {
        ...
        anonymizestrayacash = new QSpinBox(tabMain);
        anonymizestrayacash->setObjectName(QStringLiteral("anonymizestrayacash"));
        anonymizestrayacash->setMinimum(100);
        anonymizestrayacash->setMaximum(100000);
        anonymizestrayacash->setSingleStep(100);
        anonymizestrayacash->setValue(1000);

        horizontalLayout->addWidget(anonymizestrayacash);
...
#ifndef QT_NO_TOOLTIP
        bitcoinAtStartup->setToolTip(QApplication::translate("OptionsDialog", "Automatically start strayacash after logging in to the system.", 0));
#endif // QT_NO_TOOLTIP
        bitcoinAtStartup->setText(QApplication::translate("OptionsDialog", "&Start strayacash on system login", 0));
...
#endif // QT_NO_TOOLTIP
        label_2->setText(QApplication::translate("OptionsDialog", "Amount of strayacash to keep anonymized", 0));
...
#ifndef QT_NO_TOOLTIP
        mapPortUpnp->setToolTip(QApplication::translate("OptionsDialog", "Automatically open the strayacash client port on the router. This only works when your router supports UPnP and it is enabled.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        connectSocks->setToolTip(QApplication::translate("OptionsDialog", "Connect to the strayacash network through a SOCKS5 proxy.", 0));
#endif // QT_NO_TOOLTIP
...
#ifndef QT_NO_TOOLTIP
        lang->setToolTip(QApplication::translate("OptionsDialog", "The user interface language can be set here. This setting will take effect after restarting strayacash.", 0));
#endif // QT_NO_TOOLTIP
...
"https://www.transifex.com/strayacash-project/strayacash-project-translations", 0));
