...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("strayacash"),
     ...
     * override -datadir in the strayacash.conf file in the default data directory
     * (to be consistent with strayacashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
