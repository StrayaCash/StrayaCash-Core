...
/** Utility functions used by the strayacash Qt UI.
 */
namespace GUIUtil
{
...
// Render strayacash addresses in monospace font
...
// Parse "strayacash:" URI into recipient object, return true on successful parsing
