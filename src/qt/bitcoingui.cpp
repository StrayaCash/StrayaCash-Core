                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("strayacash") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a strayacash address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and strayacash: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About strayacash"), this);
    aboutAction->setStatusTip(tr("Show information about strayacash"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for strayacash"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your strayacash addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified strayacash addresses"));
    ...
    openAction->setStatusTip(tr("Open a strayacash: URI or payment request"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the strayacash help message to get a list with possible strayacash command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("strayacash client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to strayacash network", "", count));
}
...
{
    QString strTitle = tr("strayacash"); // default title
