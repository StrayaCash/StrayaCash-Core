/* src/config/strayacash-config.h.  Generated from strayacash-config.h.in by configure.  */
/* src/config/strayacash-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef strayacash_CONFIG_H

#define strayacash_CONFIG_H
...
#define PACKAGE_BUGREPORT "www.strayacash.org" //Updated URL

/* Define to the full name of this package. */
#define PACKAGE_NAME "strayacash Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "strayacash Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "strayacash"
