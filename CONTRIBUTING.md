Contributing to strayacash
============================

The strayacash project operates an open contributor model where anyone is
...
The following applies to code changes to the strayacash project, and is not to be
confused with overall strayacash Network Protocol consensus changes.

Whether a pull request is merged into strayacash rests with the project merge
...
Patches that change strayacash consensus rules are considerably more involved than
...
Where a patch set proposes to change the strayacash consensus, it must have been
...
The project leader is the release manager for each strayacash release.
